...
Our vatSys dataset currently ships with three plugins, the VATNZ Standard Route Tool, the Multiple ATIS Editor and the VATNZ Plugin for automatic sector extenstion. 
