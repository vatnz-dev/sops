...
=== "Runway 02"
    ...
    <figure markdown>
      ![NZCH Runway 02 terminal-area split](../../assets/nzch-runway-02-event-split.png)
...
=== "Runway 20"
    ...
    <figure markdown>
      ![NZCH Runway 20 terminal-area split](../../assets/nzch-runway-20-event-split.png)
      <figcaption>NZCH event split - Runway 20</figcaption>
    </figure>

## Event-only Procedures

The following procedures apply to all runway splits shown above.
...
Use the runway 02 split shown above. The general arrival and departure procedures apply.

### Runway 20

Use the runway 20 split shown above. The general arrival and departure procedures apply.
